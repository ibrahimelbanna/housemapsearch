...
var Searchbar = React.createClass({
  ...
  getCurrentLocation: function() {
   ...
   savePosition: function() {
    var wishRef = new Firebase('https://3kartest.firebaseio.com/Position');
  ...
  render: function() {
    return (
      <div className="search-container">
        ...
        <span className="current-location-txt" onClick={this.savePosition}>واقف فين </span>
